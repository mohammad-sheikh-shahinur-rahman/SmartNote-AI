...
/**
 * @fileOverview This file defines a Genkit flow for summarizing notes into bullet points.
 *
...
const SummarizeNoteOutputSchema = z.object({
  summary: z.string().describe('The summarized content of the note in bullet points.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `Summarize the following note into bullet points:\n\n{{{noteContent}}}`,
});
